...
def check():
 ...
 if p.scheme!='https' or not p.hostname or p.path not in ('','/') or p.query or p.fragment or p.username:errors.append('VANTIX_PUBLIC_URL must be the HTTPS site origin')
